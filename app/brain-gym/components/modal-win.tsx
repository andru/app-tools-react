...
export const WinModal = ({onRestart, onShowScores}: Props) => {
  ...
  const percentImprovement = result.percentImprovement;

  return (
  <div className="modal complete win modal--show">
    ...
    <div className="modal__inner">
      <div className="modal__header">
        <h1 className="modal__title">New Personal Record!</h1>
      ...
      <div className="modal__content">
        ...
        <div><br /><b>That's <span className="percent-improvement">{percentImprovement}</span>% better than your average!</b></div>
        <div><br />Having too much fun to stop? If you want to play again, we'll record your highest score of the day.</div>
      </div>
