...
export const dummyGames: Game[] = [
  {
    rounds: [
      { cards: 6, moves: 309, time: 4000 },
      { cards: 12, moves: 99, time: 350 },
      { cards: 16, moves: 220, time: 350 },
      { cards: 20, moves: 220, time: 350 },
    ],
    date: new Date('2023-12-10')
  },
  {
    rounds: [
      { cards: 6, moves: 22, time: 50 },
      { cards: 12, moves: 20, time: 50 },
      { cards: 16, moves: 22, time: 50 },
      { cards: 20, moves: 22, time: 50 },
    ],
    date: new Date('2024-01-10')
  },
  {
    rounds: [
      { cards: 6, moves: 19, time: 40 },
      { cards: 12, moves: 20, time: 40 },
      { cards: 16, moves: 20, time: 40 },
      { cards: 20, moves: 20, time: 40 },
    ],
    date: new Date('2025-02-11')
  },
  {
    rounds: [
      { cards: 6, moves: 12, time: 30 },
  ...
  {
    rounds: [
      { cards: 6, moves: 18, time: 30 },
      { cards: 12, moves: 13, time: 30 },
      { cards: 16, moves: 18, time: 30 }, 
      { cards: 20, moves: 20, time: 40 },
  ...
  {
    rounds: [
      { cards: 6, moves: 9, time: 30 },
      { cards: 12, moves: 12, time: 30 },
      { cards: 16, moves: 15, time: 40 },
      { cards: 20, moves: 20, time: 40 },
    ],
  ...
  {
    rounds: [
      { cards: 6, moves: 6, time: 10 },
      { cards: 12, moves: 9, time: 22 },
      { cards: 16, moves: 12, time: 30 },
      { cards: 20, moves: 20, time: 40 },
    ],
